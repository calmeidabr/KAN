...
INSERT INTO empresas (nome_empresa, razao_social, cnpj, segmento, num_colaboradores, site, telefone, email, responsavel_nome, responsavel_celular, responsavel_email, logo)
VALUES 
